...
def es_builder():
    audio_dir = BASE_OUT / "mls_es_0p1h_wav"
    ds_dir = BASE_OUT / "mls_es_0p1h_ds"
    ...
    for ex in stream:
        ...
        out_wav = audio_dir / f"es_{saved}.wav"
    ...
    print("Spanish dataset saved:", ds_dir)
